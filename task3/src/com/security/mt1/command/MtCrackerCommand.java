...
public class MtCrackerCommand implements ExampleCommand {
    ...
    public void execute() throws Exception {
        ...
        final Optional<Bet> tryWinBet1 = Client.createBet(MODE, PLAYER_ID, 500, serverGenerator.nextInt());
        final Optional<Bet> tryWinBet2 = Client.createBet(MODE, PLAYER_ID, 600, serverGenerator.nextInt());
